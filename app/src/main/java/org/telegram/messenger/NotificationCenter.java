...
public class NotificationCenter {
    ...
    public static final String TAG = "TGNotificationCenter";
    ...
    public void postNotificationNameInternal(int id, boolean allowDuringAnimation, Object... args) {
        if (BuildConfig.DEBUG) {
            if (Thread.currentThread() != DiagramApplication.getInstance().getApplicationHandler().getLooper().getThread()) {
        ...
        if (!allowDuringAnimation && animationInProgress) {
            ...
            if (BuildConfig.DEBUG) {
                Log.e(TAG,"delay post notification " + id + " with args count = " + args.length);
            }
            return;
        }
        broadcasting++;
